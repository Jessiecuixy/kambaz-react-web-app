  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <br /><br /><hr />
			...
			<h3>Editing description in an Array</h3>
			<a className="btn btn-primary float-end float-end"
      ...
      <br /><br /><hr />
			...
			<h3>Editing completed in an Array</h3>
			<a className="btn btn-primary float-end mb-2"
			...
			<div className="d-flex align-items-center mb-2">
				<FormControl defaultValue={todo.id} className="w-25 float-start me-2"
					onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
				<FormCheck type="checkbox" label="Completed" checked={todo.completed}
