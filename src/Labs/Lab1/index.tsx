export default function Lab1() {
  return (
    <div id="wd-lab1">
      ...
      <a id="wd-github" href="https://github.com/Jessiecuixy/kambaz-react-web-app">GitHub Repository</a>
      <h3>HTML Examples</h3>
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
...
between long pieces of text like this one.
        </p>
        <p id="wd-p-3"> 
This is the second paragraph. Even though there is a deliberate white gap between 
the paragraph above and this paragraph, by default browsers render them as one 
contiguous piece of text as shown here on the right.
        </p>
        <p id="wd-p-4"> 
This is the third paragraph. Wrap each paragraph with the paragraph tag to tell 
browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Add water.</li>
          <li>Add butter and eggs.</li>
          <li>Mix well.</li>
          <li>Pour into pancake maker and heat.</li>
          <li>Enjoy delicious waffles!</li>
        </ol>
